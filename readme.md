...
é conhecido como "engine", ou seja, motor. Existem vários outros programas
mas nem sempre têm uma boa documentação do código fonte e geralmente
está em inglês.
...
A documentação será feita sob a forma de comentários em cada código fonte.
