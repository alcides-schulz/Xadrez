...
namespace Enxadrista
{
    ...
    /// 
    /// Para começar, você usará os comandos de linha que podem ser digitados quando
    /// você inicia Enxadrista.exe. A sintaxe dos comandos dependerá do protocolo que você usa.
    /// Existem dois protocolos que podem ser usados: XBoard e UCI. Os programas gráficos geralmente 
    /// aceitam ambos os protocolos. 
    /// Enxadrista é desenvolvido para usar o Xboard, também conhecido como Winboard. Na fonte do protocolo 
    /// "Xboard.cs", há uma discussão sobre os dois protocolos.
    /// 
    ...
    /// A forma mais comum usada na pesquisa é a pesquisa alfa/beta.
    /// Algumas técnicas utilizadas durante a pesquisa, que foram programadas neste programa, são:
    /// - pesquisa de variação principal - principal variation search (PVS)
    ...
    /// Assim, juntamente com a procura, o motor determina o movimento que levará a melhores posições.
    ...
    /// A profundidade é o número de movimentos que o programa poderá alcançar. Por examplo a profundidade
    ...
    ///   otimizar uma pequena função do programa. Mas certifique que o programa funciona corretamente antes de tentar 
    ...
    ///     - stockfish: este é um dos programas mais fortes do mundo, com a vantagem de ser gratis e ser código aberto.
    ...
    /// RESPOSTA: veja o item "Disciplina e Persistência" acima. As ideias de um programa nem sempre funcionam diretamente 
    ...
    /// durante a pesquisa. O uso do comando GC.Collect() ajudou um pouco.
